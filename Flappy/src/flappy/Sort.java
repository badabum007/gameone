...
public class Sort {
    ...
    public void sortInScala() {
        ScalaSort scSort = new ScalaSort();
        Date data = new Date();
        time = data.getTime();
        scSort.sort(sortMas);
        data = new Date();
        time = data.getTime() - time;
        recordList("FileSortInScala.txt");
    }

    public void getStatistic() {
        Statistic stat = new Statistic();
        gameStat = new ArrayList<>(stat.getStatistic(sortMas));
        DialogStatistic ds = new DialogStatistic(gameStat);
    }
